// Lucide glyphs (ISC), one canonical table — union of the menu/POS/admin sets,
// bell/bell-ring corrected to the real Lucide paths. Stored as raw inner-SVG
// markup so this module needs no framework import; render inside
//   <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
//        stroke-linecap="round" stroke-linejoin="round">
// via dangerouslySetInnerHTML (or equivalent).
...
export const GLYPHS: Record<string, string> = {
  ...
  "triangle-alert":
    '<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 20h16a2 2 0 0 0 1.73-2"/><path d="M12 9v4"/><path d="M12 17h.01"/>',
